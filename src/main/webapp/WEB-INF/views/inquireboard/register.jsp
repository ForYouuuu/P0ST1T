  ...
  <div class="container" >
    <div class="row mb-2">
        <div class="col-2"></div>
             ...
             <div class="boardHeader col-8 card py-2"><h1 style="color: white;">문의하기 등록</h1></div></div>
    ...
    <div class="col-8 card ">
      <form role="form" action="/inquireboard/register" method="post">

      <div class="form-group">
        <label for="title">제목</label>
          <input id="title" class="form-control" maxlength="30" name="title" placeholder="제목은 3글자 이상 입력해주세요." value="${inquireBoardVO.title}">
            <span>	${valid_title }</span>
      </div>

      <div class="form-group">
        <label for="content">내용</label>
          <textarea id="content" class="form-control" maxlength="2000" rows="10" placeholder="내용은 10글자 이상 입력해주세요." name="content">${inquireBoardVO.content}</textarea>
              <span>${valid_content }</span>
      </div>

      <div class="form-group">
        <label for="writer">작성자</label>
        <input class="form-control" placeholder="Enter text" id="writer" name="writer" value="${inquireBoardVO.writer}" readonly>
      </div>
...
<%@include file="/WEB-INF/views/footer.jsp"%>
	<script>
	document.title = "문의하기 등록 - POST 1T";
