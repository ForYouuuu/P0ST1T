...
<div id="body-wrapper">
    ...
    <div class="container" >
      ...
      <div class="row mb-2">
                  ...
                  <div class="boardHeader col-10 card py-2"><h1 style="color: white;">문의하기</h1></div></div>
        ...
        <div class="container">
              <div class="d-flex justify-content-end mb-3">
                ...
                <form id="operForm" action="/inquireboard/modify" method="get">
        ...
        if("${isLiked}" == "true"){
         ...
         <!-- 게시글 상세 -->
           	    ...
           	    $("button[data-oper='modify']").on('click', function(e){
           		    operForm.attr("action","/inquireboard/modify").submit();
           	     });

           	    $("button[data-oper='list']").on("click",function(e){
               		operForm.find("#bno").remove();
           	    	operForm.attr("action", "/inquireboard/list");
           		    operForm.submit();
           	     });
          });
  </script>
