...
<div class="container" >
    <div class="row mb-2">
        <div class="col-2"></div>
             ...
             <div class="boardHeader col-8 card py-2"><h1 style="color: white;">문의하기 수정</h1></div></div>

      <div class="row">
        <div class="col-2"> </div>

        <div class="col-8 card ">
           <form role="form" action="/inquireboard/modify" method="post">
              ...
              <div class="form-group">
                <label for="content">내용</label>
                    <textarea id="content" class="form-control" maxlength="2000" rows="3" placeholder="내용은 10글자 이상 입력해주세요." name="content"><c:out value="${vo.content}"/></textarea>
...
document.title = "문의하기 수정 - POST 1T";
$(document).ready(function(){
	...
	$('button').on("click", function(e){
		...
		if(operation === "remove"){
			formObj.attr("action", "/inquireboard/remove");

		}else if(operation ==="list"){
			formObj.attr("action","/inquireboard/list").attr("method","get");
