...
<div class="container text-center">
    <div class="row">
        <div class="col-Lg-12">
            <form action="/inquireboard/list" id="searchForm">
...
<form id="actionForm" action="/inquireboard/list" method='get'>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#regBtn").on("click", function () {
            self.location = "/inquireboard/register"; //원래 있던 창을 저 창으로 바꾸는거임
        });
        ...
        $(".move").on("click", function (e) {
            ...
            console.log("move~");
            actionForm.append("<input type='hidden' name='bno' value='" + $(this).attr("href") + "'>");
            actionForm.attr("action", "/inquireboard/get");
            actionForm.submit();
        });
