...
<div class="container" >
    <div class="row mb-2">
        <div class="col-2"></div>
             ...
             <div class="boardHeader col-8 card py-2"><h1 style="color: white;">공지사항 수정</h1></div></div>
           ...
           <form role="form" action="/noticeboard/modify" method="post">
              ...
              <div class="form-group">
                <label for="title">제목</label>
                    <input id="title" class="form-control" name="title" placeholder="제목은 3글자 이상 입력해주세요." maxlength="30"
...
document.title = "공지사항 수정- POST 1T";
