            ...
            <div class="row">
                ...
                <div class="col-10 card ">
                    <div class="form-group">
                        <input type="hidden" class="form-control" name="bno" value='<c:out value="${vo.bno}"/>'
                            readonly>
                    </div>

                    <div class="d-flex flex-column form-group mt-2">
                        <div class="d-flex align-items-center mb-1" style="width:100%;">
                            <input class="form-control-plaintext" style="font-size:25px;width:100%;display:inline;"
                                name="title" value='<c:out value="${vo.title}"/>' readonly>

                        </div>
                        <div style="padding-right:15px;"><span style=" text-align:center;">작성자
                                <c:out value="${vo.writer}" /></span>
                            <span style="margin-left:20px; text-align:center;">작성일
                                <fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss" value="${vo.updatedate }" /></span>
                            <span style="text-align:center;float:right;">조회수
                                <c:out value="${vo.viewcount}" /></span>
                        </div>
                    </div>
                    <hr>
                    <div class="form-group">
                        <textarea class="form-control-plaintext" rows="3" name="content"
