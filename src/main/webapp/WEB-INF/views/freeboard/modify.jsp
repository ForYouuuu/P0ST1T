        ...
        <div class="container">
            <div class="row mb-2">
                ...
                <div class="boardHeader col-8 card py-2">
                    <h1 style="color: white;">자유게시판 수정</h1>
                </div>
            </div>
                ...
                <div class="col-8 card ">
                    <form role="form" action="/freeboard/modify" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input id="title" class="form-control" maxlength="30" name="title" placeholder="제목은 3글자 이상 입력해주세요." value='<c:out value="${vo.title}"/>'>
                            <span> ${valid_title }</span>
                        </div>

                        <div class="form-group">
                            <label for="content">내용</label>
                            <textarea id="content" class="form-control" rows="3" maxlength="2000" placeholder="내용은 10글자 이상 입력해주세요."
                                name="content"><c:out value="${vo.content}"/></textarea>
                            <span>${valid_content }</span>
                        </div>

                        <div class="form-group">
                            <label for="writer">작성자</label>
                            <input id="writer" class="form-control" name="writer" value='<c:out value="${vo.writer}"/>' readonly>
                        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-sm-12 text-lg-end text-center ">
                                    <button type="submit" data-oper='modify'
                                        class="btn btn-light justify-content-right">저장</button>
...
<script type="text/javascript">
    document.title = "자유게시판 수정 - POST 1T";
