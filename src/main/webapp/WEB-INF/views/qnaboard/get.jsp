...
<div id="body-wrapper">
    ...
    <div class="container" >
      ...
      <div class="row mb-2">
                  ...
                  <div class="boardHeader col-10 card py-2"><h1 style="color: white;">묻고답하기<span style="margin-left:10px;font-size:20px;">[<c:out value="${vo.qname}"/>]</span></h1></div></div>
                ...
                <div class="col-10 card ">
                  <div class="form-group">
                                <input type="hidden" class="form-control-plaintext" name="bno"  value='<c:out value="${vo.bno}"/>' readonly>
                            </div>
